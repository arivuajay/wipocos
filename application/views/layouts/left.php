        ...
        <?php if (!Yii::$app->user->isGuest) : ?>
            <div class="user-panel">
                <div class="pull-left image">
                    <?= Html::img("@web/adminlte/img/avatar5.png", ['class' => 'img-circle', 'alt' => 'User Image']); ?>
                </div>
                <div class="pull-left info">
                    <p>Hello, <?= @Yii::$app->user->identity->name ?></p>
...
//            );
        ...
        echo Nav::widget(
                [
                    ...
                    'options' => ['class' => 'sidebar-menu'],
                    'items' => [
                        ['label' => '<i class="fa fa-dashboard"></i> <span>Dashboard</span>', 'url' => Yii::$app->homeUrl],
                        ['label' => '<i class="fa fa-th"></i> <span>Document Activities</span>', 'url' => '#'],
                        ['label' => '<i class="fa fa-laptop"></i> <span>Distribution Activities</span>', 'url' => '#'],
                        ['label' => '<i class="fa fa-th"></i> <span>International Databases</span>', 'url' => '#'],
                        ['label' => '<i class="fa fa-user"></i> <span>Users & Customers</span>', 'url' => '#'],
                        ['label' => '<i class="fa fa-th"></i> <span>Administration</span>', 'url' => '#',
